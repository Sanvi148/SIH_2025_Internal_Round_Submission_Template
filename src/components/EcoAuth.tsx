...
const EcoAuth = ({ onBack, onAuthSuccess, isDarkTheme, onToggleTheme }: EcoAuthProps) => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 px-4 transition-colors duration-300">
      ...
      {showFloatingElements && floatingElements.map(({ Icon, position, delay }, index) => (
        <motion.div
          key={index}
          className="absolute text-emerald-600/30 dark:text-emerald-400/30 pointer-events-none hidden md:block"
          style={position}
        ...
        {!selectedRole ? (
          ...
          >
            <motion.div variants={itemVariants} className="mb-12">
              <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <h1 className="text-emerald-800 dark:text-emerald-200 mb-0">Choose Your Role</h1>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {roles.map((role, index) => {
                ...
                return (
                  ...
                  >
                    <Card className={`h-full transition-all duration-300 hover:shadow-lg ${role.borderColor} dark:border-gray-600 border-2 bg-gradient-to-br ${role.bgGradient} dark:from-gray-800 dark:to-gray-700 backdrop-blur-sm`}>
                      <CardContent className="p-8 text-center h-full flex flex-col">
                        ...
                        <h3 className={`mb-4 ${role.textColor} dark:text-gray-200`}>{role.title}</h3>
                        <p className="text-slate-700 dark:text-gray-300 flex-grow leading-relaxed">
                          {role.description}
                        </p>
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-8">
              ...
              <h1 className="text-emerald-800 dark:text-emerald-200 mb-2">
            ...
            <Card className="border-2 border-emerald-200 dark:border-gray-600 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg">
              <CardContent className="p-8">
                <motion.div variants={itemVariants}>
                  {/* Google Login */}
                  <Button
                    variant="outline"
                    className="w-full mb-6 h-12 border-2 border-emerald-200 dark:border-gray-600 hover:border-emerald-300 dark:hover:border-gray-500 hover:bg-emerald-50/50 dark:hover:bg-gray-700/50"
                  ...
                  <div className="relative mb-6">
                    <div className="absolute inset-0 flex items-center">
                      <div className="w-full border-t border-emerald-200 dark:border-gray-600" />
                    </div>
                    <div className="relative flex justify-center text-sm">
                      <span className="bg-white dark:bg-gray-800 px-4 text-emerald-600 dark:text-emerald-400">or</span>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleEmailLogin} className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="h-12 border-emerald-200 dark:border-gray-600 focus:border-emerald-400 dark:focus:border-emerald-500 focus:ring-emerald-200 bg-white dark:bg-gray-800"
                        required
                      />
                    </div>
                  ...
                  <div className="text-center mt-6">
                    <button
                      ...
                      className="text-emerald-700 dark:text-emerald-300 hover:text-emerald-800 dark:hover:text-emerald-200 underline transition-colors"
                    >
