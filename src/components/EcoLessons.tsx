                    ...
                    <div className="flex gap-2 mt-4">
                      ...
                      <Button
                        onClick={(e) => {
                          ...
                          onNavigateToAI({
                            ...lesson,
                            category: lesson.category === 'energy' ? 'Renewable Energy' : 
                                     lesson.category === 'water' ? 'Water Conservation' : 
                                     lesson.category === 'waste' ? 'Waste Reduction' : 
                                     lesson.category === 'nature' ? 'Biodiversity Conservation' : lesson.category
                          });
                        }}
                        variant="outline"
                        className="flex-1 border-blue-200 dark:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/50"
                        size="sm"
                      >
